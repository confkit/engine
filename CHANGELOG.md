...
- 完善 CLI 功能 - 新增 config/health/dry-run 命令, 重构 clean 为子命令, 补全 log 交互与清理, 支持 -v 版本缩写
...
- 优化日志输出结构
- 新增 log info 命令
- 优化日志 存储/查询, 扁平化存储, sqlite 进行元数据存储, 支持分页查询列表
- 增加 HOST_VOLUMES_DIR 变量访问支持
...
- Release confkit-engine version 0.4.1
## [0.4.0] - 2025-09-15
