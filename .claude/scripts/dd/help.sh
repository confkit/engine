...
echo "  1. /dd:init                    - 初始化新项目"
echo "  2. /dd:init-local              - 初始化本地项目"
echo "  3. /dd:prd                     - 项目需求设计"
echo "  4. /dd:ui                      - UI 原型设计 (可选)"
echo "  5. /dd:framework-init          - 项目框架设计"
echo "  6. /dd:prd-decompose           - 需求拆解 (基于 PRD 拆解功能模块)"
echo "  7. /dd:feature-add <功能>       - 添加新功能"
echo "  8. /dd:feature-decompose <功能>  - 功能拆解多个议题"
echo "  9. /dd:issue-start <功能>:<议题> - 开始执行具体议题"
echo " 10. /dd:issue-update <功能>:<议题> - 更新议题进度"
echo " 11. /dd:feature-update <功能>    - 更新功能状态"
echo " 12. /dd:code-reflect            - 代码变更反思分析"
echo ""
echo "📄 功能管理命令"
...
echo "  本地项目初始化: "  
echo "    /dd:init-local → /dd:framework-audit → /dd:framework-adjust → /dd:feature-add → /dd:feature-start"
echo "  功能开发迭代: "
