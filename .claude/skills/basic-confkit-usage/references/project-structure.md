...
A ConfKit CI project follows a fixed directory convention. Understanding the layout helps locate config files, builder definitions, and runtime data.
...
Runtime data directories, auto-created on startup. See `references/volumes.md` for details.
